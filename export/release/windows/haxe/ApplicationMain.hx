...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Rising Volume", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Rising Volume", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Rising Volume";
		app.meta["name"] = "Friday Night Funkin': Rising Volume";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: true,
			title: "Friday Night Funkin': Rising Volume",
			width: 1280,
			x: null,
			y: null,
		};
